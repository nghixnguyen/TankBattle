...
public class GameConstants {
    public static final int GAME_WORLD_WIDTH = 1740;
    public static final int GAME_WORLD_HEIGHT = 1290;

    public static final int GAME_SCREEN_WIDTH = 1290;
    public static final int GAME_SCREEN_HEIGHT = 810;


    public static final int START_MENU_SCREEN_WIDTH = 500;
    public static final int START_MENU_SCREEN_HEIGHT = 550;

    public static final int GAME_CONTROL_SCREEN_WIDTH = 500;
    public static final int GAME_CONTROL_SCREEN_HEIGHT = 550;
