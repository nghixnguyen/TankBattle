...
import tankrotationexample.menus.GameControlPanel;
import tankrotationexample.menus.PowerUpPanel;
...
//    private GameControlPanel controlGame;
    ...
    private void initUIComponents(){
        ...
        JPanel controlPanel = new GameControlPanel(this);
        JPanel powerUpPanel = new PowerUpPanel(this);
         ...
         */
        endGame = new EndGamePanel(this); // create a new end game pane;
        ...
        this.mainPanel.add(controlPanel, "control");
        this.mainPanel.add(powerUpPanel, "powerup");
    ...
    public void setFrame(String type){
        ...
        switch (type) {
            ...
            case "control", "powerup" ->
                // set the size of the jFrame to the expected size for the end panel
                    this.jf.setSize(GameConstants.GAME_CONTROL_SCREEN_WIDTH, GameConstants.GAME_CONTROL_SCREEN_HEIGHT);
